...
function b(e, t, n = /* @__PURE__ */ new WeakSet()) {
  ...
  if (o != r) return false;
  let S2 = e instanceof Date, A = t instanceof Date;
  if (S2 != A) return false;
  if (S2 && A) return e.getTime() == t.getTime();
  let I = e instanceof RegExp, L = t instanceof RegExp;
  if (I != L) return false;
  if (I && L) return e.toString() == t.toString();
  let F3 = Object.keys(e);
  if (f = F3.length, f !== Object.keys(t).length) return false;
  for (u = f; u-- !== 0; ) if (!Object.prototype.hasOwnProperty.call(t, F3[u])) return false;
  for (u = f; u-- !== 0; ) if (T = F3[u], !b(e[T], t[T], n)) return false;
  return true;
}
function y(e, t) {
  return b(e, t);
...
function O(t, e = {}) {
  if (p2(t)) {
    let o = (r, i2) => {
      var a2, l3;
      let s4 = (a2 = t == null ? void 0 : t.$attrs) != null && a2[r] ? [(l3 = t == null ? void 0 : t.$attrs) == null ? void 0 : l3[r]] : [];
      return [i2].flat().reduce((d, f) => {
        if (f != null) {
          let c3 = typeof f;
          if (c3 === "string" || c3 === "number") d.push(f);
          else if (c3 === "object") {
            let u = Array.isArray(f) ? o(r, f) : Object.entries(f).map(([g3, w2]) => r === "style" && (w2 || w2 === 0) ? `${g3.replace(/([a-z])([A-Z])/g, "$1-$2").toLowerCase()}:${w2}` : w2 ? g3 : void 0);
            d = u.length ? d.concat(u.filter((g3) => !!g3)) : d;
          }
        }
        return d;
      }, s4);
      ...
      o("style", r).forEach((s4) => {
        let a2 = s4.indexOf(":");
        if (a2 < 0) return;
        let l3 = s4.slice(0, a2).trim(), d = s4.slice(a2 + 1).trim();
    ...
    Object.entries(e).forEach(([r, i2]) => {
      if (i2 != null) {
        let s4 = r.match(/^on(.+)/);
        s4 ? t.addEventListener(s4[1].toLowerCase(), i2) : r === "p-bind" || r === "pBind" ? O(t, i2) : r === "style" ? (n(i2), (t.$attrs = t.$attrs || {}) && (t.$attrs[r] = t.style.cssText)) : (i2 = r === "class" ? [...new Set(o("class", i2))].join(" ").trim() : i2, (t.$attrs = t.$attrs || {}) && (t.$attrs[r] = i2), t.setAttribute(r, i2));
      }
    });
  }
}
...
function g() {
  let r = [], i2 = (e, n, t = 999) => {
    let s4 = u(e, n, t), o = s4.value + (s4.key === e ? 0 : t) + 1;
    return r.push({ key: e, value: o }), o;
  }, d = (e) => {
    r = r.filter((n) => n.value !== e);
  }, a2 = (e, n) => u(e, n).value, u = (e, n, t = 0) => [...r].reverse().find((s4) => n ? true : s4.key === e) || { key: e, value: t }, l3 = (e) => e && parseInt(e.style.zIndex, 10) || 0;
  return { get: l3, set: (e, n, t) => {
    n && (n.style.zIndex = String(i2(e, true, t)));
  }, clear: (e) => {
    e && (d(l3(e)), e.style.zIndex = "");
...
function le(e, t) {
  ...
  for (let n = 0; n < e.length; n++) if (e[n] === "d" && e.slice(n, n + 3) === "dt(") a2.push(n), n += 2;
    ...
    let l3 = a2.pop();
    a2.length === 0 && i2.push([l3, n]);
  }
  if (!i2.length) return e;
  for (let n = i2.length - 1; n >= 0; n--) {
    let [l3, o] = i2[n], c3 = e.slice(l3 + 3, o), m3 = r(c3, t), d = t(...m3);
...
var ue = (e = {}, t, r, s4) => {
  if (t) {
    let { variable: i2, options: a2 } = S.defaults || {}, { prefix: n, transform: l3 } = (e == null ? void 0 : e.options) || a2 || {}, o = G(t, k2) ? t : `{${t}}`;
    return s4 === "value" || l2(s4) && l3 === "strict" ? S.getTokenValue(t) : Y3(o, void 0, n, [i2.excludedKeyRegex], r);
  }
  return "";
};
function ar(e, ...t) {
  if (e instanceof Array) {
    let r = e.reduce((s4, i2, a2) => {
      var n;
      return s4 + i2 + ((n = m2(t[a2], { dt: E })) != null ? n : "");
    }, "");
    return le(r, E);
  }
  return m2(e, { dt: E });
...
function de(e, t = {}) {
  let r = S.defaults.variable, { prefix: s4 = r.prefix, selector: i2 = r.selector, excludedKeyRegex: a2 = r.excludedKeyRegex } = t, n = [], l3 = [], o = [{ node: e, path: s4 }];
  for (; o.length; ) {
    let { node: m3, path: d } = o.pop();
    for (let u in m3) {
      let g3 = m3[u], f = ve(g3), p3 = G(u, a2) ? Q(d) : Q(d, re(u));
      if (i(f)) o.push({ node: f, path: p3 });
      else {
        let y2 = ae(p3), R = Y3(f, p3, s4, [a2]);
        Re(l3, y2, R);
        let T = p3;
  ...
  let c3 = l3.join("");
  return { value: l3, tokens: n, declarations: c3, css: C2(i2, c3) };
}
var b2 = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(e) {
  ...
  if (s2(a2) && n.transform !== "strict") {
    ...
    d = `${et}${tt}`, u = [.../* @__PURE__ */ new Set([...We, ...Ze, ...Je])], g3 = m2(a2.css, { dt: E });
  }
  return { primitive: { css: l3, tokens: o }, semantic: { css: c3, tokens: m3 }, global: { css: d, tokens: u }, style: g3 };
}, getPreset({ name: e = "", preset: t = {}, options: r, params: s4, set: i2, defaults: a2, selector: n }) {
  var f, x3, p3;
  let l3, o, c3;
  if (s2(t) && r.transform !== "strict") {
    let y2 = e.replace("-directive", ""), m3 = t, { colorScheme: R, extend: T, css: j } = m3, O2 = v(m3, ["colorScheme", "extend", "css"]), d = T || {}, { colorScheme: M } = d, z2 = v(d, ["colorScheme"]), u = R || {}, { dark: V } = u, L = v(u, ["dark"]), g3 = M || {}, { dark: te2 } = g3, re2 = v(g3, ["dark"]), K = s2(O2) ? this._toVariables({ [y2]: h(h({}, O2), z2) }, r) : {}, A = s2(L) ? this._toVariables({ [y2]: h(h({}, L), re2) }, r) : {}, X2 = s2(V) ? this._toVariables({ [y2]: h(h({}, V), te2) }, r) : {}, [G2, U] = [(f = K.declarations) != null ? f : "", K.tokens || []], [B, I] = [(x3 = A.declarations) != null ? x3 : "", A.tokens || []], [H2, W] = [(p3 = X2.declarations) != null ? p3 : "", X2.tokens || []], q2 = this.transformCSS(y2, `${G2}${B}`, "light", "variable", r, i2, a2, n), Z = this.transformCSS(y2, H2, "dark", "variable", r, i2, a2, n);
    l3 = `${q2}${Z}`, o = [.../* @__PURE__ */ new Set([...U, ...I, ...W])], c3 = m2(j, { dt: E });
  }
  return { css: l3, tokens: o, style: c3 };
}, getPresetC({ name: e = "", theme: t = {}, params: r, set: s4, defaults: i2 }) {
  var o;
  let { preset: a2, options: n } = t, l3 = (o = a2 == null ? void 0 : a2.components) == null ? void 0 : o[e];
  return this.getPreset({ name: e, preset: l3, options: n, params: r, set: s4, defaults: i2 });
}, getPresetD({ name: e = "", theme: t = {}, params: r, set: s4, defaults: i2 }) {
  var c3, m3;
  let a2 = e.replace("-directive", ""), { preset: n, options: l3 } = t, o = ((c3 = n == null ? void 0 : n.components) == null ? void 0 : c3[a2]) || ((m3 = n == null ? void 0 : n.directives) == null ? void 0 : m3[a2]);
  return this.getPreset({ name: a2, preset: o, options: l3, params: r, set: s4, defaults: i2 });
  ...
  let n = this.getCommon({ name: e, theme: t, params: r, set: i2, defaults: a2 }), l3 = Object.entries(s4).reduce((o, [c3, m3]) => o.push(`${c3}="${m3}"`) && o, []).join(" ");
  ...
  var c3;
  let n = { name: e, theme: t, params: r, set: i2, defaults: a2 }, l3 = (c3 = e.includes("-directive") ? this.getPresetD(n) : this.getPresetC(n)) == null ? void 0 : c3.css, o = Object.entries(s4).reduce((m3, [d, u]) => m3.push(`${d}="${u}"`) && m3, []).join(" ");
  ...
  let a2 = function(l3, o = {}, c3 = []) {
    ...
    if (typeof this.value == "string" && k2.test(this.value)) {
      let u = this.value.trim().replace(k2, (g3) => {
        var y2;
        let f = g3.slice(1, -1), x3 = this.tokens[f];
        if (!x3) return console.warn(`Token not found for path: ${f}`), "__UNRESOLVED__";
        let p3 = x3.computed(l3, o, c3);
    ...
    Object.entries(l3).forEach(([m3, d]) => {
      ...
      i(d) ? n(d, u, g3) : (i2[u] || (i2[u] = { paths: [], computed: (f, x3 = {}, p3 = []) => {
        ...
        if (f && f !== "none") for (let y2 = 0; y2 < i2[u].paths.length; y2++) {
          let R = i2[u].paths[y2];
          if (R.scheme === f) return R.computed(f, x3.binding, p3);
        }
  ...
  var l3;
  let i2 = ((o) => o.split(".").filter((m3) => !G(m3.toLowerCase(), r.variable.excludedKeyRegex)).join("."))(t), a2 = t.includes("colorScheme.light") ? "light" : t.includes("colorScheme.dark") ? "dark" : void 0, n = [(l3 = e[i2]) == null ? void 0 : l3.computed(a2)].flat().filter((o) => o);
...
}, transformCSS(e, t, r, s4, i2 = {}, a2, n, l3) {
  if (s2(t)) {
    let { cssLayer: o } = i2;
    if (s4 !== "style") {
      let c3 = this.getColorSchemeOption(i2, n);
      t = r === "dark" ? c3.reduce((m3, { type: d, selector: u }) => (s2(u) && (m3 += u.includes("[CSS]") ? u.replace("[CSS]", t) : this.getSelectorRule(u, l3, d, t)), m3), "") : C2(l3 != null ? l3 : ":root,:host", t);
    }
    if (o) {
      let c3 = { name: "primeui", order: "primeui" };
      i(o) && (c3.name = m2(o.name, { name: e, type: s4 })), s2(c3.name) && (t = C2(`@layer ${c3.name}`, t), a2 == null || a2.layerNames(c3.name));
    }
    return t;
  }
  return "";
